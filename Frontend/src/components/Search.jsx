  ...
  return (
    <div className="my-1 flex items-center justify-center flex-col border rounded-2xl h-[150px] w-[300px] md:h-[300px] md:w-[500px] px-[50px] gap-5 overflow-hidden">
      ...
      <form onSubmit={(e) => { submitHandler(e); }} className="w-full flex gap-4 flex-col justify-center items-center py-4 md:flex-row">
        <input className="w-full md:w-[70%] h-[20px] md:h-[40px] border px-4 rounded-xl overflow-hidden" type="text" name="url" placeholder="http://google.com" value={url} onChange={(e) => { setUrl(e.target.value); }} />
        <button type="submit" className="w-[100px] h-[20px] md:h-[40px] md:w-[30%] text-sm md:text-xl rounded-xl border border-dashed border-gray-200">
          <BsArrowsAngleContract className="inline-block h-[15px]" />
